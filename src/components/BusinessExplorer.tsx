...
import { businesses, detailImageIdForBusiness } from '../data/businesses'
  ...
  return (
    <>
      ...
      <div className="hidden lg:grid lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-16">
        <ul className="flex flex-col" role="tablist" aria-label="Explore Nova Ventures businesses" aria-orientation="vertical">
          {businesses.map((b) => {
        ...
        >
          <SiteImage id={detailImageIdForBusiness(active.id)} sizes="(min-width: 1024px) 45vw, 100vw" />
            ...
            <div key={b.id}>
              ...
              >
                <div className="min-h-0">
                  <SiteImage id={detailImageIdForBusiness(b.id)} sizes="100vw" />
